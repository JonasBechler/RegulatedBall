...
// Most of the functionality of this library is based on the VL53L0X library from Pololu
// which is based on the VL53L0X API
...
void VL53L0X::startTimeout()
{
  ...
  timeout_start_ms = (uint16_t)to_ms_since_boot(now);
}
